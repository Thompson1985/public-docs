...
{% hint style="info" %}
If you want to use the Assistant tab, [GitBook Assistant must be enabled](../../ai-and-search/gitbook-ai-assistant.md) for your docs site (Settings → AI & MCP).
{% endhint %}
{% endstep %}
...
{% hint style="info" %}
If your docs use [Authenticated Access](../../site-access/authenticated-access/), follow the steps in [how to set up the embed with authenticated docs](using-with-authenticated-docs.md).
{% endhint %}
{% endstep %}
