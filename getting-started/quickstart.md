...
Whichever workflow you prefer, you’ll edit your content using a **branch-based editing flow**. Find out more on [the Concepts page](../resources/concepts.md).
...
Head to [the Concepts page](../resources/concepts.md) to find out more about site navigation.

Head to [the Site structure page](../docs-site/site-structure/) to find out more about adding content to your site.
...
You can customize your site’s [logo, colors and font](../docs-site/customization/icons-colors-and-themes.md), add to your site navigation bar using [site sections](../docs-site/site-structure/site-sections.md) and [variants](../docs-site/site-structure/variants.md), update your [site’s visibility](../docs-site/site-settings.md#audience) settings and much more.
