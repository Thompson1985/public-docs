...
Git Sync also unlocks many other useful workflows in your GitBook docs, such as batch changes, linting, and more. Learn more in [our Git Sync section](../getting-started/git-sync/).
...
You can also control who sees individual pages or blocks using a feature called adaptive content. Once set up, it will show or hide content based on user attributes that you decide upon. Read more in [the Adaptive content pages](../site-access/adaptive-content/).
...
Read more on [the Permissions and inheritance page](../collaboration/member-management/permissions-and-inheritance.md).
